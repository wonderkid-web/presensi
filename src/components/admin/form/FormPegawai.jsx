...
export default function FormPegawai() {
  ...
  const { data: jabatan } = useRealtime(collectionJabatan);
      ...
      <div className="p-4 flex justify-center max-w-[85vw]">
        ...
        >
          ...
          <div className=" mt-4">
            ...
            >
              {jabatan.map((j) => (
                <option key={uuid()} value={j.jabatan}>
                  {j.jabatan.toUpperCase()}
                </option>
              ))}
            </select>
          </div>
          ...
          <div className="col-span-full mt-4">
            <Button type="submit" className="bg-blue-500 w-full hover:bg-blue-600">
              Kirim
            </Button>
          </div>
        </form>
